...
export async function getSmsSchedulePreview(supabase, { syncFirst = true } = {}) {
  if (syncFirst) {
  ...
  for (const client of clients) {
    ...
    const requiredDays = next.requiredDays;
    const daysUntilSend = next.daysUntilSend;
  ...
  return {
    ...
    rules: {
      ...
      note:
        ...
        "Reminders pause while a client has an upcoming Square appointment or for 30 days after they cancel one. " +
